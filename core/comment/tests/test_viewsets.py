...
class TestCommentViewSet:
    ...
    def test_create(self, client, user, post):
        client.force_authenticate(user=user)
        data = {'body': 'Test Comment Body', 'author': user.public_id.hex, 'post': post.public_id.hex}
    ...
    def test_update(self, client, user, post, comment):
        client.force_authenticate(user=user)
        data = {'body': 'Test Comment Body Updated', 'author': user.public_id.hex, 'post': post.public_id.hex}
